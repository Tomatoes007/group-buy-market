...
public class MarketTradeControllerTest {
    ...
    public void test_lockMarketPayOrder() {
        ...
        lockMarketPayOrderRequestDTO.setUserId("ZHIMIN");
        lockMarketPayOrderRequestDTO.setTeamId("64755036");
    ...
    public void test_lockMarketPayOrder_teamId_not_null() {
        LockMarketPayOrderRequestDTO lockMarketPayOrderRequestDTO = new LockMarketPayOrderRequestDTO();
        lockMarketPayOrderRequestDTO.setUserId("lzm");
        lockMarketPayOrderRequestDTO.setTeamId("67974226");
        lockMarketPayOrderRequestDTO.setActivityId(100123L);
        lockMarketPayOrderRequestDTO.setGoodsId("9890001");
        lockMarketPayOrderRequestDTO.setSource("s01");
        lockMarketPayOrderRequestDTO.setChannel("c01");
